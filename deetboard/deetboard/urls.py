...
Welcome to DeetBoard 

This URL config is a bit messy at the moment

Reorganization will move app specific URLs into their

respective urls.py files

TODO:

Separate URL files for each app imported to here
